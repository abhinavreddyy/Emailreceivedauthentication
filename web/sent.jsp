...
<%
	...
	ResultSet rs=st.executeQuery("select * from mail where sender='"+email+"'");
%>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
	...
	<div id="ww">
	    <div class="container">
                ...
                <center><h2>Sent Mails</h2></center>
